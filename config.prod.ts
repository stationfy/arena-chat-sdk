export const API_V2_URL = 'https://api.arena.im/v2';
export const CACHED_API = 'https://cached-api.arena.im/v1';
...
export const GRAPHQL_ENDPOINT = 'https://public.arena.im/graphql';
