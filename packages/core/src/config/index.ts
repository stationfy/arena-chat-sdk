...
export type ConfigProperties =  'EU' | 'USA' | 'LOCAL'
...
export class CoreConfig {
    private static configInstance: CoreConfig;
    private static _enviroment: EnvType | null = null;
    private enviroments: EnvDataType={
        EU: {
    ...
    constructor(env: ConfigProperties) {
        console.log('entrando no construtor...')
        CoreConfig._enviroment = env === 'EU' ? this.enviroments.EU :  this.enviroments.USA; 
    }
  
    public static get instance(): CoreConfig {
      if (!CoreConfig.configInstance) {
        CoreConfig.configInstance = new CoreConfig('USA');
      }else{
        console.log('Config instace not created...')
      }
  
      return CoreConfig.configInstance;
    }

    public static get enviroment(): EnvType | null {
        return CoreConfig._enviroment;
    }
